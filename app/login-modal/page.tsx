...
export default function page() {
  return (
    <div className="min-h-screen bg-pink-500/15 flex items-center justify-center">
      <div className="flex flex-col bg-white md:flex-row rounded-lg shadow-xl w-sm md:w-fit  md:h-152">
        <div className="p-10 space-y-5 md:w-md">
          ...
          <div>
            <input
              ...
              className="border w-full p-5  rounded border-zinc-300 placeholder:text-zinc-500/50"
            />
          </div>
          ...
          <div className="flex flex-col md:justify-between md:items-center md:flex-row space-y-5">
            ...
            <div className=" text-white text-center hover:shadow-xl duration-300  hover:-translate-y-1 transition-all flex flex-row items-center justify-center gap-5  bg-cyan-600 p-5 rounded">
          ...
          <div className="flex flex-col md:justify-between md:flex-row gap-5">
            {/* Facebook */}
            <div className="flex-row flex justify-center border p-2 rounded border-zinc-300 hover:-translate-y-1 transition-all duration-300 hover:shadow-xl items-center gap-4">

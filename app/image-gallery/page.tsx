...
export default function page() {
  return (
    <div className="bg-cyan-200/30 min-h-screen flex justify-center items-center">
      {/* container */}
      <div className="flex flex-col md:w-full md:m-5 bg-white rounded-xl w-xs">
        {/* NavBar */}
        ...
        {/* Images */}
        <div className="flex mb-10 md:flex-row w-[80%] mx-auto  mt-10 md:space-x-5 flex-col  md:space-y-0 space-y-4">
          {images.map((image) => (
            <div className="group relative">
              <img
                ...
                alt="pic"
              />
              <div className="absolute text-white bg-black rounded-b-lg p-2 w-full bottom-0  opacity-0 group-hover:opacity-70 transition-all duration-300">
